...
public class PauseMenuScriptHvisNavnetErTagetErJegFucked : MonoBehaviour
{
    ...
    [SerializeField] GameObject FMigHvadLaverJegIkkeDom; // inds�t PCount
    [SerializeField] List<List<GameObject>> TheHolesInScoreboard = new List<List<GameObject>>(); // TheHolesInScoreboard[0][0] = Hul tekst, TheHolesInScoreboard[0][1] = point tekst og frem til s� mange spillere der er, TheHolesInScoreboard[0][2 + playercount] objektet som holder p� dem
